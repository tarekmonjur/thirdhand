                    ...
                    <div class="panel-body">
                        <form method="POST" action="{{ url('product-store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('product_description') ? ' has-error' : '' }}">
                                ...
                                <textarea id="product_description" type="text" class="form-control" name="product_description">{{ old('product_description') }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('product_feature') ? ' has-error' : '' }}">
                                ...
                                <textarea id="product_feature" type="text" class="form-control" name="product_feature">{{ old('product_feature') }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('product_faq') ? ' has-error' : '' }}">
                                ...
                                <textarea id="product_faq" type="text" class="form-control" name="product_faq">{{ old('product_faq') }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('product_work') ? ' has-error' : '' }}">
                                ...
                                <textarea id="product_work" type="text" class="form-control" name="product_work">{{ old('product_work') }}</textarea>
